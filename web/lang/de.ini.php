...
View = Ansehen
players = Spieler
and clans ranked on = und Clans gelistet auf
servers = Servern
...
hover over the bars to get more information = fahre über die Balen um mehr Informationen zu bekommen
Aliases = Aliase
Used = Verwendet
...
Days" or "*" above are generated from the player's Event History. Player kill, death and suicide totals and points ratings cover the entire recorded period = Tage" oder "*" sind aus der Speilerhsitorie erstellt. Frags,Kills oder Selbstmorde sind auf die gesamte Aufzeichnungsperiode bezogen
